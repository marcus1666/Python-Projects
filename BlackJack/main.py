...
#black jack is also known as 21
...
def blackjack():
    ...
    while start_game:
        if input("Do you want to play a game of BlackJack? Y/N: ").lower() == "y":
            ...
            #If first output is 2 11, this would be 22, so we set one of the aces to 1
            if sum(my_cards) == 22:
                my_cards = [11, 1]
            if sum(dealers_cards) == 22:
                dealers_cards == [11, 1]
            ...
            while sum(dealers_cards) <= 16:
                dealers_cards.append(random.choice(cards))
                while sum(dealers_cards) <= sum(my_cards) and sum(dealers_cards) < 21:
                    dealers_cards.append(random.choice(cards))
            ...
            if winner == "dealer":
                final()
                print(f"You went over, You loose") 
                
            elif sum(dealers_cards) > 21:
                final()
                print("You win")
                                
            elif sum(dealers_cards) == sum(my_cards):
                final()
                print("You Draw")
            elif sum(dealers_cards) < sum(my_cards) and sum(my_cards) < 21:
                final()
                print("You Win")
            elif sum(dealers_cards) > sum(my_cards) and sum(dealers_cards) < 21:
                final()
                print("Dealer Wins")
